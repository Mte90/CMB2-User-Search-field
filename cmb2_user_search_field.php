...
if ( !function_exists( 'cmb2_user_search_render_js' ) ) {
...
if ( !function_exists( 'cmb2_user_search_field_add_find_users_div' ) ) {

	/**
	 * Add the find posts div via a hook so we can relocate it manually
	 */
	function cmb2_user_search_field_add_find_users_div() {
...
if ( !function_exists( 'find_users_div' ) ) {
...
if ( !function_exists( 'wp_ajax_find_users' ) ) {
...
if ( !function_exists( 'cmb2_user_search_field_display_name' ) ) {
